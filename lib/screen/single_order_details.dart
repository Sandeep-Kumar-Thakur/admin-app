...
class SingleOrderDetails extends StatelessWidget {
  ...
  SingleOrderDetails({Key? key, required this.storeCartModel})
      : super(key: key);
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                  color: Colors.white, boxShadow: myShadow),
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                        "Item Name : ${storeCartModel.cartItem![i].itemName}-${storeCartModel.cartItem![i].itemGrade}" ??
                                            ""),
                                    Text(
                                        "Item Quantity : ${storeCartModel.cartItem![i].itemQuantity} x ${storeCartModel.cartItem![i].itemCount}"),
                                    Text(
                                        "Item Total Price : ₹ ${storeCartModel.cartItem![i].itemTotal}"),
                                  ],
                                ),
                              ),
                            ),
                ...
                Expanded(
                  ...
                  onTap: () {
                    ...
                    FirebaseRealTimeStorage()
                        .changeOrderStatus(storeCartModel: storeCartModel);
                  },
                  child: Container(
                    height: 50,
